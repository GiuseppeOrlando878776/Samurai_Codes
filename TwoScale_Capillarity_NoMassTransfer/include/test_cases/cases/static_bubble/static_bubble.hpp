 ...
 * ----------------------
 * A static bubble is considered. This configuration is standardly used
...
void StaticBubble<Traits, AuxFields>::init_variables(Context& ctx,
  ...
  // Initialize the volume fraction to define the static bubble with a loop over all cells
