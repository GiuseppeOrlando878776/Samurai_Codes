...
namespace samurai {
  ...
  FluxValue<typename Flux<Field>::cfg> RusanovFlux<Field>::compute_discrete_flux(const FluxValue<typename Flux<Field>::cfg>& qL,
    ...
    /*--- Verify if left and right state are coherent ---*/
      ...
      if(m_d_L < static_cast<typename Field::value_type>(0.0)) {
      ...
      if(rho_z_L < static_cast<typename Field::value_type>(0.0)) {
      ...
      if(m_d_R < static_cast<typename Field::value_type>(0.0)) {
      ...
      if(rho_z_R < static_cast<typename Field::value_type>(0.0)) {
    ...
    const auto c_L       = std::sqrt((static_cast<typename Field::value_type>(1.0) - Y_g_L)*
                                     ...
                                     this->EOS_phase_gas.c_value(rho_g_L) -
                                     static_cast<typename Field::value_type>(2.0/9.0)*sigma*Sigma_d_L*inv_rho_L);
    ...
    const auto c_R       = std::sqrt((static_cast<typename Field::value_type>(1.0) - Y_g_R)*
                                     ...
                                     static_cast<typename Field::value_type>(2.0/9.0)*sigma*Sigma_d_R*inv_rho_R);
