...
//
#ifndef HLLC_6eqs_flux_conservative_alpha_hpp
#define HLLC_6eqs_flux_conservative_alpha_hpp
...
namespace samurai {
  ...
  auto HLLCFlux<Field>::compute_middle_state(const FluxValue<typename Flux<Field>::cfg>& q,
    ...
    q_star(ALPHA1_INDEX)      = (q_star(ALPHA1_RHO1_INDEX) + q_star(ALPHA2_RHO2_INDEX))*alpha1;
