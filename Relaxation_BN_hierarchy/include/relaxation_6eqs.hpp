...
private:
  ...
  void get_min_alpha(const double time); /*--- Get track of the minimum value of volume fraction ---*/
...
void Relaxation<dim>::apply_instantaneous_pressure_relaxation() {
  ...
  samurai::for_each_cell(mesh,
                         [&](const auto& cell)
                         {
                            ...
                            typename Field::value_type alpha_max = 1.0;
                            typename Field::value_type alpha_min = 0.0;
