...
namespace samurai {
  ...
  /**
    * Implementation of a HLLC flux (wave-propagation)
    */
  ...
  private:
    auto compute_middle_state(const FluxValue<cfg>& q,
                              const Number S,
                              const Number S_star,
  ...
  //
  template<class Field>
  auto HLLCFlux<Field>::compute_middle_state(const FluxValue<cfg>& q,
                                             const Number S,
                                             const Number S_star,
