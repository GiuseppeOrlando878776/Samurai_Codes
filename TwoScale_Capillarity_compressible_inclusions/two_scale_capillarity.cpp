...
int main(int argc, char* argv[]) {
  ...
  sim_param.alpha1_min       = input.value("alpha1_min", 0.01);
  sim_param.alpha1_max       = input.value("alpha1_max", 0.1);
  ...
  app.add_option("--alpha1_min", sim_param.alpha1_min,
                 "Minimum volume fraction for the mixture region")->capture_default_str()->group("Simulation parameters");
  app.add_option("--alpha1_max", sim_param.alpha1_max,
                 "Maximum volume fraction for the mixture region")->capture_default_str()->group("Simulation parameters");
