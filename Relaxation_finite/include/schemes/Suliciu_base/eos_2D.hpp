...
inline double P1(Etat e)
{
  ...
  double e1 = (e.alrhoE1-e.alrhou1*e.alrhou1/2./e.alrho1-e.alrhov1*e.alrhov1/2./e.alrho1)/e.alrho1;
  return p1(r1,e1);
}
...
inline double P2(Etat e)
{
  ...
  double e2 = (e.alrhoE2-e.alrhou2*e.alrhou2/2./e.alrho2-e.alrhov2*e.alrhov2/2./e.alrho2)/e.alrho2;
  return p2(r2,e2);
}
