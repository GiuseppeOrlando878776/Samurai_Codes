...
class Etat
{
	public:
		...
		// variables
		double al1, alrho1, alrhou1, alrhov1, alrhoE1, alrho2, alrhou2, alrhov2, alrhoE2;

		// Constructeur
		Etat() : al1(0.), alrho1(0.), alrhou1(0.), alrhov1(0.), alrhoE1(0.), alrho2(0.), alrhou2(0.), alrhov2(0.), alrhoE2(0.) {}

		Etat(double a, double b, double c, double d, double e, double f, double g, double h, double i) :
			al1(a),	alrho1(b), alrhou1(c), alrhov1(d), alrhoE1(e), alrho2(f), alrhou2(g), alrhov2(h), alrhoE2(i) {}
