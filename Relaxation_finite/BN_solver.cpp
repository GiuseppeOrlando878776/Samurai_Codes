...
int main(int argc, char* argv[]) {
  ...
  app.add_option("--apply_relaxation", sim_param.apply_relaxation,
                 "Choose whether to apply relaxation or not")->capture_default_str()->group("Physical parameters");
  ...
  app.add_option("--relax_velocity", sim_param.relax_velocity,
                 "If instantaneous relaxation, relax the velocity")->capture_default_str()->group("Numerical parameters");
  ...
  app.add_option("--atol_Newton_Suliciu", sim_param.atol_Newton_Suliciu,
                 "Absolute tolerance Newton method in Suliciu scheme")->capture_default_str()->group("Numerical parameters");
  app.add_option("--rtol_Newton_Suliciu", sim_param.rtol_Newton_Suliciu,
                 "Relative tolerance Newton method in Suliciu scheme")->capture_default_str()->group("Numerical parameters");
  app.add_option("--max_Newton_iters", sim_param.max_Newton_iters,
                 "Maximum number of iterations of Newton method")->capture_default_str()->group("Numerical parameters");

  app.add_option("--atol_Newton_relaxation", sim_param.atol_Newton_relaxation,
                 "Absolute tolerance Newton method in recomputing conserved variables from deltas")->capture_default_str()->group("Numerical parameters");
  app.add_option("--rtol_Newton_relaxation", sim_param.rtol_Newton_relaxation,
                 "Relative tolerance Newton method in recomputing conserved variables from deltas")->capture_default_str()->group("Numerical parameters");
  ...
  app.add_option("--MR_param", sim_param.MR_param, "Multiresolution parameter")->capture_default_str()->group("Mesh parameter");
