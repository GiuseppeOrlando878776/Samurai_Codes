...
int main(int argc, char* argv[]) {
  ...
  sim_param.min_level = 12;
  sim_param.max_level = 12;
  ...
  sim_param.tau_u = 1e15;
  sim_param.tau_p = 1e-5;
  sim_param.tau_T = 1e15;

  sim_param.relax_pressure    = true;
  ...
  eos_param.gamma_1    = 4.4;
  eos_param.pi_infty_1 = 6e6;
  eos_param.q_infty_1  = 0.0;
  eos_param.cv_1       = 4186.0/eos_param.gamma_1;

  eos_param.gamma_2    = 1.4;
  eos_param.pi_infty_2 = 0.0;
  eos_param.q_infty_2  = 0.0;
  eos_param.cv_2       = 1004.5/eos_param.gamma_2;

  app.add_option("--gamma_1", eos_param.gamma_1, "gamma_1")->capture_default_str()->group("EOS parameters");
  ...
  app.add_option("--gamma_2", eos_param.gamma_2, "gamma_2")->capture_default_str()->group("EOS parameters");
  ...
  Riemann_param.rho1L   = 1000.0;
  Riemann_param.u1L     = 10.0;
